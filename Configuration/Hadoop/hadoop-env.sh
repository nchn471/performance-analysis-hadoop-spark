...
HDFS_NAMENODE_OPTS="$HDFS_NAMENODE_OPTS -javaagent:/opt/jmx_exporter/jmx_prometheus_javaagent-1.0.1.jar=27001:/opt/jmx_exporter/namenode.yml"
fi

#if ! grep -q <<<"$HDFS_DATANODE_OPTS" jmx_prometheus_javaagent; then
#HDFS_DATANODE_OPTS="$HDFS_DATANODE_OPTS -javaagent:/opt/jmx_exporter/jmx_prometheus_javaagent-1.0.1.jar=27002:/opt/jmx_exporter/datanode.yml"
#fi
